...
<body style="margin: 0;">
    ...
    <div class="d-flex flex-column flex-fill align-items-center"
      ...
      <?php if ($game['status'] === 'setting_secrets'): ?>
        <p class="text-muted mt-5">
          Your secret was set. Waiting for <?php echo $_SESSION['nameP1'] ?> to set secret number ⏳⏳⏳
        </p>
      ...
      <?php elseif ($game['turn'] !== 'player2'): ?>
        ...
        <p class="text-muted mt-5">
          <?php echo $_SESSION['nameP1'] ?> is guessing your number. Wait for your turn
        </p>
 ...
 <?php elseif($game['winner']==='player2'):?>
        ...
        🎉 You guessed it! The number set by <strong><?= $_SESSION['nameP1'] ?></strong> was <strong><?= $_SESSION['secretP1'] ?></strong>
    </div>
